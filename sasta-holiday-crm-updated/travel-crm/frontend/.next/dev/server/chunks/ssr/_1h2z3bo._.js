...
function LoginPage() {
    ...
    async function handleSubmit(e) {
        ...
        setLoading(true);
        try {
            const { token } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/auth/login", {
                username,
                password
            });
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setToken"])(token);
            router.push("/");
        } catch (err) {
...
//# sourceMappingURL=_1h2z3bo._.js.map